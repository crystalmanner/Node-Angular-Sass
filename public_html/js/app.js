  ...
  foundationRoutes = [
    {
      ...
      "name": "information",
      "url": "information",
      "path": "templates/information.html"
    }, {
      "name": "classes",
      "url": "/classes",
      ...
      "name": "forms-waivers	",
      "url": "/forms-waivers",
      "path": "templates/forms_waivers.html"
    }, {
      "name": "enrollment",
      "url": "/enrollment",
...
(function() {
  this.app = angular.module('application', ['ui.router', 'ngAnimate', 'foundation']);

  this.app.config([
    '$stateProvider', '$urlRouterProvider', '$locationProvider', function($stateProvider, $urlProvider, $locationProvider) {
...
(function() {
  this.app.controller('HomeCtrl', [
    '$scope', '$http', '$window', '$location', 'UserAuthFactory', 'AuthenticationFactory', function($scope, $http, $window, $location, UserAuthFactory, AuthenticationFactory) {
      ...
      $scope.forgot = function() {
        $scope.success_message = null;
        $scope.error_message = null;
        return UserAuthFactory.forgot({
          email_address: $scope.user.email_address
        }).success(function(data) {
          return $scope.success_message = 'Your password was successfully reset and emailed to you.';
        }).error(function(status) {
          return $scope.error_message = status.message;
        });
      };
      return $scope.login = function() {
        console.log($scope.password);
        console.log('start login..');
        return UserAuthFactory.login($scope.email_address, $scope.password);
      };
    }
  ]);
...
(function() {
  this.app.controller('SignupCtrl', [
    '$scope', '$window', '$location', 'UserAuthFactory', 'AuthenticationFactory', function($scope, $window, $location, UserAuthFactory, AuthenticationFactory) {
      $scope.fullname = '';
      $scope.email_address = '';
      $scope.password = '';
      $scope.success_message = null;
      ...
      return $scope.signup = function() {
        ...
        return UserAuthFactory.signup($scope.fullname, $scope.email_address, $scope.password);
      };
    }
  ]);
...
(function() {
  this.app.service('parentFactory', function($window, $location, $http) {
    var pInfo;
    pInfo = {};
    return {
      initParent: function() {
        console.log("this is init parent");
        return $http.post('http://localhost:12008/v1/member/parent/init', {}).success(function(data) {
          console.log("parent factory calling");
          pInfo = data.data;
          return console.log(pInfo);
        }).error(function(status) {
          return console.log("page init error");
        });
      },
      getData: function() {
        return pInfo;
  ...
  this.app.controller('MyInfoCtrl', [
    '$scope', '$http', '$window', '$location', '$timeout', 'parentFactory', 'AuthenticationFactory', function($scope, $http, $window, $location, $timeout, parentFactory, AuthenticationFactory) {
      var baseurl;
      ...
      $scope.edit_parent_info = function() {
        return $http.post(baseurl + '/parent/create', {
          ...
          return $scope.errpInfo.type = "success";
        }).error(function(status) {
          console.log(status);
          $scope.errpInfo.hasError = true;
          $scope.errpInfo.message = "Failed!";
          return $scope.errpInfo.type = "warning";
        });
      };
      $scope.edit_student_info = function() {
        return $http.post(baseurl + '/student/create', {
      ...
      $scope.add_scholarship = function() {
        return $http.post(baseurl + '/scholarship/create', {
      ...
      $scope.add_parent_note = function() {
        console.log("parent note");
        console.log($scope.parentNote);
        return $http.post(baseurl + '/note/create', {
      ...
      $scope.add_student_note = function() {
      ...
      $scope.pageInit = function() {
        ...
        $scope.initStudent();
        $scope.init_parentNote();
        return $scope.init_studentNote();
      };
      $scope.initParent = function() {
        console.log("this is init parent");
        return $http.post(baseurl + '/parent/init', {}).success(function(data) {
          $scope.pInfo = data.data;
          return console.log($scope.pInfo);
        }).error(function(status) {
          return console.log("page init error");
        });
      };
      $scope.initScholarship = function() {
        console.log("this is init scholarship");
        return $http.post(baseurl + '/scholarship/init', {}).success(function(data) {
      ...
      $scope.initStudent = function() {
        ...
        return $http.post(baseurl + '/student/init', {}).success(function(data) {
      ...
      $scope.init_parentNote = function() {
        console.log("parent note init");
        console.log($scope.parentNote);
        return $http.post(baseurl + '/note/parent', {}).success(function(data) {
      ...
      $scope.init_studentNote = function() {
        console.log("student note init");
        return $http.post(baseurl + '/note/student', {}).success(function(data) {
...
(function() {
  this.app.controller('ClassesCtrl', [
    '$scope', '$http', '$window', '$location', '$timeout', 'parentFactory', 'AuthenticationFactory', function($scope, $http, $window, $location, $timeout, parentFactory, AuthenticationFactory) {
      var baseurl;
      ...
      $scope.errpInfo = {};
      $scope.errpInfo.hasError = false;
      $scope.edit_staff_info = function() {
        console.log('start edit Staff signup..');
        console.log($scope.staffInfo);
        return $http.post(baseurl + '/info/create', {
      ...
      $scope.pageInit = function() {
        $scope.initStaff();
        return $scope.init_staffNote();
      };
      $scope.initStaff = function() {
        console.log("this is init staff");
        return $http.post(baseurl + '/info/init', {}).success(function(data) {
          $scope.staffInfo = data.data;
          return console.log($scope.staffInfo);
        }).error(function(status) {
          return console.log("page init error");
        });
      };
      $scope.init_staffNote = function() {
        console.log("parent note init");
        return $http.post(baseurl + '/note/init', {}).success(function(data) {
...
(function() {
  this.app.controller('PaymentCtrl', [
    '$scope', '$window', '$location', 'UserAuthFactory', 'AuthenticationFactory', function($scope, $window, $location, UserAuthFactory, AuthenticationFactory) {
      $scope.fullname = '';
      $scope.email_address = '';
      $scope.password = '';
      ...
      return $scope.signup = function() {
        return console.log('start Classes signup..');
      };
    }
  ]);
...
(function() {
  this.app.directive('fDatepicker', function() {
    return {
      link: function(scope, element, attrs) {
        return element.fdatepicker();
      }
    };
  });

  this.app.directive('fTimepicker', function() {
    return {
      link: function(scope, element, attrs) {
        return element.fdatepicker({
          dateFormat: 'hh:ii p'
  ...
  this.app.controller('WaiversCtrl', [
    '$scope', '$http', '$window', '$location', '$timeout', 'UserAuthFactory', 'AuthenticationFactory', function($scope, $http, $window, $location, $timeout, UserAuthFactory, AuthenticationFactory) {
      var baseurl;
      ...
      $scope.set_year_fee = function() {
        $scope.errpInfo.hasError = false;
        console.log('start Calender set fee..');
        return $http.post(baseurl + '/yearfee/create', {
      ...
      $scope.create_term = function() {
        $scope.errpInfo.hasError = false;
        console.log('start Calender create term...');
        console.log($scope.term);
        return $http.post(baseurl + '/term/create', {
      ...
      $scope.add_holiday = function() {
        $scope.errpInfo.hasError = false;
        console.log($scope.holiday);
        console.log('start Calender set holiday...');
        return $http.post(baseurl + '/holiday/create', {
      ...
      $scope.add_session = function() {
        ...
        console.log(session);
        return $http.post(baseurl + '/session/create', {
      ...
      $scope.initTerm = function() {
        return $http.post(baseurl + '/term/init', {}).success(function(data) {
          $scope.termDatas = data.data;
          return console.log("init term data", $scope.termDatas);
        }).error(function(status) {});
      };
      $scope.pageInit = function() {
        return $scope.initTerm();
...
(function() {
  this.app.controller('EnrollmentCtrl', [
    '$scope', '$http', '$window', '$location', '$timeout', 'parentFactory', 'AuthenticationFactory', function($scope, $http, $window, $location, $timeout, parentFactory, AuthenticationFactory) {
      $scope.pageInit = function() {
        return console.log("Billing Section init");
      };
      $scope.set_discount = function() {
        return console.log("this is set discount");
      };
      return angular.element(document).ready(function() {
        return $scope.pageInit();
      });
...
(function() {
  this.app.factory('AuthenticationFactory', function($window) {
    var auth;
    return auth = {
      isLogged: false,
      email_address: null,
      ...
      check: function() {
        if ($window.sessionStorage.token && $window.sessionStorage.email_address) {
          ...
          return this.tags = JSON.parse($window.sessionStorage.tags);
        } else {
          this.isLogged = false;
  ...
  this.app.factory('UserAuthFactory', function($window, $location, $http, AuthenticationFactory) {
    return {
      login: function(email_address, password) {
        return $http.post('http://localhost:12008/v1/auth/signin', {
          email_address: email_address,
          password: password
        }).success(function(data) {
          console.log(data);
          return window.location = '/#!/admin/members';
        }).error(function(status) {
          return console.log('failed!');
        });
      },
      signup: function(fullname, email_address, password) {
        return $http.post('http://localhost:12008/v1/auth/signup', {
          fullname: fullname,
          email_address: email_address,
          password: password
        }).success(function(data) {
  ...
  this.app.factory('TokenInterceptor', function($q, $window) {
    return {
